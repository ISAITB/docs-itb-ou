...
Your account credentials are those provided to you by your administrator or by you in case you self-registered (see :ref:`login__create_account`). Note that the email address
defined for the account is not necessarily an active address. It is rather a "functional" email address that
is linked to the test bed on which you are not expected to receive any emails.
